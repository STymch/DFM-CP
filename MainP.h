...
/*
  float          Vmin,     Vt,       Vn;           //Величины стандартов пролива  Литры
  float          Qn;                               //величина объема пролива литров в час
  float          Qt;                               //величина объема пролива литров в час
  float          Qmin;                             //величина объема пролива литров в час
  float          DQnom;                               //Дельта величины объема пролива литров в час
  float          DQt;                               //Дельта величинывеличина объема пролива литров в час
  float          DQmin;                             //Дельта величинывеличина объема пролива литров в час
*/
  float          Tmin;                             //min T izmerenija
  float          Tmax;                             //max T izmerenija

  float          QminL, QminR;                     //Правые и левые границы отклонений адля устаноления скорости потока
  float          QtL,   QtR;                       //Правые и левые границы отклонений адля устаноления скорости потока
  float          QnomL,   QnomR;                       //Правые и левые границы отклонений адля устаноления скорости потока
  float          DminL, DminR;                     //Допустимые Проценты на меньшее и больше отличия пролива
  float          DtL, DtR;                         //Допустимые Проценты на меньшее и больше отличия пролива
  float          DnL, DnR;                         //Допустимые Проценты на меньшее и больше отличия пролива
  int             TikCount;
  int             ReadedCount;                      //kol-vo prinjanix simvolov
  int             WaitCount;                        //kol-vo ozidaemix simvolov
  BYTE            Arr[24];                          //Временный буфер ввода данных
